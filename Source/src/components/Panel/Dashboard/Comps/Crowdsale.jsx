...
const Crowdsale = ({ data, loading }) => {
  ...
  return (
    <div id="crowdsale" className={`crowsale custom-card with-bg ${loading ? "center" : ""}`}>
      {loading ? (
        <Spin />
      ) : (
        <>
          <div className="remain-head">
            ...
            <span className="remain-time">
              {Math.abs(data.periodDay)} {t("days")}
            </span>
          </div>
          <ul className="sales">
            <li className="sale private">
              <h5>
                <svg
                  width="10"
                  height="10"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <circle cx="5" cy="5" r="5" fill="#FE8359" />
                </svg>
                {t("privateSale")}
              </h5>
              <div className="goal">
            ...
            <li className="sale public">
              <h5>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <circle cx="7" cy="7" r="7" fill="#18A84B" />
                </svg>
          ...
          <div className="action">
            <div className="min-buy">
              ...
              <span className="min">${data.minimumBuy}</span>
            </div>
