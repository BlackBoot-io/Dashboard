...
const ListNotifications = () => {
    ...
    const greyStarIcon = <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 23 23" fill="none">
    ...
    const bookmarkNotification = (notificationId) => {
        ...
        const foundNotificationIndex = allNotifications.findIndex(notification => notification.notificationId === notificationId);
