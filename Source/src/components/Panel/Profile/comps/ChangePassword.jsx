  ...
  const tooltipTexts = [
    {
      ...
      text: 'contain uppercase and lowercase characters'
    },
    {
      Icon: <svg xmlns="http://www.w3.org/2000/svg" width="7" height="6" viewBox="0 0 7 6" fill="none">
        <path d="M0.887207 3.2085L2.64877 5.0835L6.17152 1.3335" stroke="#009C7B" stroke-linecap="round" stroke-linejoin="round" />
    ...
    {
      Icon: <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7" viewBox="0 0 7 7" fill="none">
      ...
      <Row>
        <Col xs={24}>
          <Form.Item name="newPassword" label={<span className="input-label">{t("newPassword")}</span>}>
            <Tooltip
              title={<>
                {tooltipTexts.map(({ Icon, text }) => <div>{Icon} {text}</div>)}
              </>}
              placement="right"
              color="white"
              overlayInnerStyle={{
